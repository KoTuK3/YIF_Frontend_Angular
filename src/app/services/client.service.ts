...
export class ClientService {
  ...
  getClientProfile(): Observable<any> {
    let getClientProfileUrl: string = BASE_URL + "/Users/Current";
    return this.http.get(getClientProfileUrl);
  }

  setClientProfile(model: any): Observable<any> {
    let setClientProfileUrl: string = BASE_URL + "/Users/Current/SetProfile";
    return this.http.post(setClientProfileUrl, model);
  }

  setClientPhoto(model: any): Observable<any> {
    let setClientProfileUrl: string = BASE_URL + "/Users/Current/ChangePhoto";
    return this.http.post(setClientProfileUrl, model);
  }
}
